...
def request_id(*, request: Request) -> str:
    """
    Provide the request identifier associated with the given request, binding and returning a new one if none exists.
    
    Returns:
        str: The request identifier; newly generated and bound to the request if no existing ID was found.
    """
