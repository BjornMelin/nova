...
* [x] Add `TransferUsageWindow` counters and conditional quota enforcement.
* [x] Add scheduled janitor/reconciler workflow for stale sessions, ambiguous completes, repeated aborts, and zombie export MPUs.
* [x] Add AppConfig profiles and validators for app/workload policy rollout.
* [x] Add Storage Lens, budgets, and stale-MPU alarms.
...
* [x] Quota rejection paths are deterministic and user-visible.
* [x] Stale sessions expire without waiting for DynamoDB TTL deletion.
* [x] Incomplete MPU alarms and runbook actions exist.
* [x] Policy rollout/rollback is tested with AppConfig deployment controls.

**Tests**

* [x] Quota unit tests with conditional-update conflicts.
* [x] Janitor integration tests using mocked stale session states.
* [x] AppConfig schema validation tests.

**Rollback**

* [x] Disable policy rollout and revert to env/static defaults.
* [x] Disable janitor schedule.
* [x] Set quotas to effectively unlimited platform-safe values.
...
* [x] Add SQS Standard queue + DLQ + Lambda part-copy workers for giant exports.
* [x] Add export part state model (`ExportCopyPart` table or manifest+status equivalent).
* [x] Add two-lane export choice in Step Functions:

  * inline lane for moderate exports,
  * worker lane for giant exports.
* [x] Add selective TA policy tier.
* [x] Add phased checksum policy:
...
* Benchmarked threshold for queue lane activation verified with the repo perf harness.
* Worker idempotency model implemented with replay-safe claim/finalize handling.

**Acceptance criteria**

* [x] Giant export path survives retry/duplication without corruption.
* [x] Queue backlog, DLQ, and cancel semantics are observable.
* [x] TA can be enabled per policy without affecting default path.
* [x] Sign requests per 500 GiB upload are reduced materially from current baseline.

**Tests**

* [x] Worker idempotency tests.
* [x] Export partial-failure replay tests.
* [x] Contract tests for new policy/capability surface.
* [x] Perf tests for giant-upload and giant-export tiers.

**Rollback**

* [x] Set giant-export threshold above any real workload so all exports stay inline.
* [x] Disable TA in policy profiles.
* [x] Disable checksum-required tiers.
...
* [x] Add `UploadSession` table
* [x] Add `TransferUsageWindow` table
* [x] Add SQS queue + DLQ + event source mapping for giant export worker lane
* [x] Add AppConfig resources or references
* [x] Add CloudWatch alarms/dashboards for new metrics
* [x] Add runtime env/config contract fields
* [x] Extend IAM grants
* [x] Extend deploy outputs only if post-deploy validation needs new resource identifiers

### 8.8 SDK impact and regeneration points

Any additive field/route change means:

* [x] update OpenAPI source
* [x] regenerate TS SDK
* [x] regenerate Python SDK
* [x] regenerate R artifacts if affected
* [x] update Dash/browser integration docs
* [x] update contract tests and generated smoke tests
...
* [x] Add quota enforcement on initiate/sign — **Owner: API Platform**
...
* [x] Implement giant export worker lane — **Owner: Workflow Platform**
* [x] Add janitor/reconciler workflow — **Owner: Workflow Platform**

**Infra / CDK**

* [x] Provision DDB tables, queues, alarms, IAM updates — **Owner: Infra**
* [x] Add AppConfig resources or bindings — **Owner: Infra**
...
* [x] Add Storage Lens and budget alarms — **Owner: FinOps**
* [x] Review IAM least privilege and encryption tier — **Owner: Security**
* [x] Validate checksum policy and presigned URL guardrails — **Owner: Security + Client Platform**
...
* [x] Quota-exceeded errors are deterministic

**Workflow**

* [x] Cancel stops active executions
* [x] Queue workers are idempotent
* [x] DLQ handling and replay tested
* [x] Janitor resolves stale/ambiguous sessions safely
...
* [x] Sign requests per giant upload materially reduced
* [ ] No unexpected DDB throttle or spend spikes
* [x] TA only active on allow-listed profiles
