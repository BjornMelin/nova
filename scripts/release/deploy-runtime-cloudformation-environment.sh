...
if [ "$JOBS_SQS_VISIBILITY_TIMEOUT_SECONDS" -lt 0 ] || [ "$JOBS_SQS_VISIBILITY_TIMEOUT_SECONDS" -gt 43200 ]; then
  echo "Error: JOBS_SQS_VISIBILITY_TIMEOUT_SECONDS must be between 0 and 43200 (12 hours)" >&2
  exit 1
fi
