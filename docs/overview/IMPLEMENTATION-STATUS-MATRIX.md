...
| SDK layout | canonical TypeScript package is `packages/nova_sdk_ts` published as `@nova/sdk`; TS generation uses `@hey-api/openapi-ts` with generated fetch client output; Python and R package renames remain on later branches | one package per language, Hey API / openapi-python-client / httr2 | `ADR-0037`, `SPEC-0030`, `docs/clients/CLIENT-SDK-CANONICAL-PACKAGES.md` |
