...
| AWS runtime | HTTP API + Lambda Web Adapter + Step Functions Standard via `infra/nova_cdk` | ECS/Fargate runtime stacks and worker deploy control plane | `ADR-0033`, `SPEC-0029`, `infra/nova_cdk/README.md` |
