...
- Active runbooks must describe the public API Lambda runtime as one
  process-reused `ApiRuntime` container bootstrapped outside Mangum lifespan.
...
- [requirements.md](../architecture/requirements.md) -- current-state
