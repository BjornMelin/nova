...
`FILE_TRANSFER_API_BASE_URL`, `FILE_TRANSFER_JOBS_QUEUE_URL`, `FILE_TRANSFER_JOBS_REGION`, `APP_SYNC_PROCESSING_MAX_BYTES`, `JOBS_API_BASE_URL`, `JOBS_WORKER_UPDATE_TOKEN`
