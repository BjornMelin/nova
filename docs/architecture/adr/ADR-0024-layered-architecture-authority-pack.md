...
Nova infrastructure is standardized on native CloudFormation templates only, with
explicit module boundaries and import/export contracts across foundation, IAM,
CodeBuild, CI/CD, and runtime stacks.
...
- 2026-03-03: Updated ADR scope to native-CFN modular stack authority.
