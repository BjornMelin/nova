...
Version: 1.1
Date: 2026-03-03
Superseded-by: "[ADR-0032: OIDC and IAM role partitioning for deploy automation](../ADR-0032-oidc-and-iam-role-partitioning-for-deploy-automation.md)"
Related:
...
- 2026-03-05: Superseded by [ADR-0032](../ADR-0032-oidc-and-iam-role-partitioning-for-deploy-automation.md); filename retained under `superseded/` for traceability (replaced by active ADR-0032).
