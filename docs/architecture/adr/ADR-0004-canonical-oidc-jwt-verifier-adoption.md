...
- A: Keep Auth0-specific verifier in `aws-file-transfer-api`.
- B: Build custom generic OIDC verifier in `aws-file-transfer-api`.
...
- `aws-file-transfer-api` provides `auth/oidc_verifier.py` as adapter layer.
